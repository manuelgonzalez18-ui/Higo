// Dataset estático de ubicaciones de Higuerote/Venezuela.
//
// NOTA (auditoría #11): este módulo ya NO usa Gemini. Las funciones de IA
// (searchPlaces, chatWithAI, generateSpeech) eran código muerto — no se
// invocaban desde ningún componente — y embebían VITE_GEMINI_API_KEY en el
// bundle del APK, donde era extraíble (riesgo de costo/abuso de quota).
// Se eliminaron junto con la dependencia @google/genai. Si en el futuro se
// reactiva la IA, debe ir detrás de un proxy PHP server-side (la key NUNCA
// en el cliente). El único consumidor actual es LocationInput.jsx, que usa
// el dataset MOCK de abajo como fuente local de sugerencias.
